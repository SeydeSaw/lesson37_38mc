...
public class Test2 {
    ...
    public static void getArray(int[] array){
        ...
        for (int i = order.length -1;i > -1 ; i--) {//i=0, написать не можем и поэтому пришем i больше -1,т.е. 0
            // TODO: 02.02.23 Почему проходит по массиву order, а не array?
        ...
        for (int i = 0; i < reverse.length; i++) { // TODO: 02.02.23 Почему проходит по массиву reverse, а не order?
